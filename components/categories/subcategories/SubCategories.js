  ...
  return (
    <Card>
      <div className="flex flex-wrap items-center justify-between">
        <Typography className="text-base font-semibold text-gray-600 lg:px-2 lg:text-lg">Subcategories</Typography>
...
function CategoryRows({ subCategory, index }) {
  ...
  const { name, enabled, slug } = subCategory;
  ...
  return (
    <tr className="rounded text-gray-600 transition-all duration-200 hover:bg-gray-50">
      ...
      <td className="p-4 text-left text-xs first:rounded-l-xl last:rounded-r-xl sm:text-sm lg:text-base">
        <Typography className="whitespace-nowrap hover:text-gray-900">{slug}</Typography>
      </td>
      ...
      <td className="w-14 first:rounded-l-xl last:rounded-r-xl">
        <Menu placement="left-start">
          <MenuHandler>
            <IconButton className="flex items-center justify-center rounded-full" variant="text" color="gray">
