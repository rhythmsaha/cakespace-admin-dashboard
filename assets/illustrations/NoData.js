                ...
                <g transform="translate(78 50)">
                    ...
                    <g fillRule="nonzero">
                        <path
                            ...
                            opacity=".32"
                        />
                        <g stroke="#919eab" strokeDasharray="2 2" strokeWidth="1.2">
                            <path
                                d="m146 54h-50c-2.7636667 0-5 2.2363333-5 5v60c0 2.763667 2.2363333 5 5 5h50c2.763667 0 5-2.236333 5-5v-60c0-2.7636667-2.236333-5-5-5z"
                                fill="#919eab"
                                fillOpacity=".48"
                                mask="url(#c)"
                            />
                            <path
                                d="m26 64h20c2.7636667 0 5-2.2363333 5-5s-2.2363333-5-5-5h-20c-2.7636667 0-5 2.2363333-5 5s2.2363333 5 5 5z"
                                mask="url(#c)"
                                opacity=".72"
                            />
                            <path
                                d="m76 74h-50c-2.7636667 0-5 2.2363333-5 5s2.2363333 5 5 5h50c2.7636667 0 5-2.2363333 5-5s-2.2363333-5-5-5z"
                                mask="url(#c)"
                                opacity=".72"
                            />
                            <path
                                d="m76 94h-50c-2.7636667 0-5 2.2363333-5 5 0 2.763667 2.2363333 5 5 5h50c2.7636667 0 5-2.236333 5-5 0-2.7636667-2.2363333-5-5-5z"
                                mask="url(#c)"
                                opacity=".72"
                            />
                            <path
                                d="m76 114h-50c-2.7636667 0-5 2.236333-5 5s2.2363333 5 5 5h50c2.7636667 0 5-2.236333 5-5s-2.2363333-5-5-5z"
                                mask="url(#c)"
                                opacity=".72"
                            />
                        </g>
